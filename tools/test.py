#!/usr/bin/env python3
"""Run device-independent tests: package/URL validation and tame-list parsing, no root or network."""
import os
import sys
...
with tempfile.TemporaryDirectory(prefix='package-management-test-') as directory:
    ...
    subprocess.run([tool('java'), '-ea', '-cp', directory, 'TamePresetsTest'], check=True)
